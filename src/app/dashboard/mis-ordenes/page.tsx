...
const MisOrdenesPage: React.FC = () => {
    ...
    // Función para cargar las órdenes del cliente
    const fetchClientOrders = async () => {
        if (!user?.id) return; // No fetch if user ID is not available
    ...
    // Efecto para cargar las órdenes al montar el componente o cuando el usuario esté listo
    useEffect(() => {
    ...
    // Función para obtener el color del estado (reutilizada del admin panel)
